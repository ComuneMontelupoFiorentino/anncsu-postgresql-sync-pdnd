...
- database `PostGIS` in cui sono salvati i dati dei civici
...
LoA=LoA2 / SPID
user_id=MARIO ROSSI
schema=accessi_anncsu
tabella_accessi=indirizzi_anccsu
vista_accessi=accessi_coordinate
allineato_tabella_accessi=conferito
progr_vista_accessi=progressivo_accesso
coord_x=coord_x_4326
coord_y=coord_y_4326
metodo=metodo
codcom=F551
```
...
tabella_operazioni=anncsu_script_jobs
progr_naz=progressivo_nazionale
progr_tabella_operazioni=progressivo_accesso
progr_tabella_accessi=progressivo_accesso
civico=civico
esp=esponente
sez_cens=sez_censimento
coord_x=x
coord_y=x
metodo=metodo
